...
import womenEarring from '../assets/womenearing.jpg';  // Replace with your actual image path
...
const WomenEarringPage = () => {
  ...
  return (
    ...
    >
      ...
      {/* Inquiry Form Modal */}
      <SendInquiryModal open={open} onClose={handleClose} selectedRing="Women Earrings" />
    </Box>
  );
};
